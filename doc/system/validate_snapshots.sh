...
ASSEMBLED_OUTPUT="${1:-$ROOT_DIR/doc/NLOSYSTEM.md}"
...
require_contains "$PARTS_DIR/_index.md" "**Designation:** NLO" "index designation"
require_contains "$PARTS_DIR/_index.md" "BDS Documentation Protocol v2.0" "index protocol"
require_contains "$PARTS_DIR/_index.md" 'Primary output: `doc/NLOSYSTEM.md`' "index primary output"
require_contains "$PARTS_DIR/BUILD.sh" 'DESIGNATION="NLO"' "build designation"
...
require_contains "$ASSEMBLED_OUTPUT" "**Designation:** NLO" "assembled designation"
require_contains "$ASSEMBLED_OUTPUT" 'Primary output: `doc/NLOSYSTEM.md`' "assembled primary output"
